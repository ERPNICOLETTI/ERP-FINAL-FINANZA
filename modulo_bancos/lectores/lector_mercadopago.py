...
def procesar_archivo(filepath: str) -> tuple[bool, dict]:
    ...
    try:
        ...
        # 6. Correr el Verificador de Integridad Automático en Caliente
        try:
            ...
            if res_v['status'] != 'OK':
                print(f"⚠️ [DISCREPANCIA DETECTADA EN INGESTA MERCADO PAGO] Staging ID: {staging_id} | Desvío: {res_v.get('diferencias')}")
